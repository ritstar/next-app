        ...
        <nav className="bg-slate-300 w-full border-b md:border-0 md:static">
            <div className="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8">
                ...
                <a href='https://github.com/ritstar/next-app' target='_blank'>
                    <button className={`flex font-mono font w-auto items-center gap-2 px-4 py-2 text-indigo-600 bg-indigo-50 rounded-lg duration-150 hover:bg-indigo-100 active:bg-indigo-200 md:block ${state ? 'block' : 'hidden'}`}>
                        ⭐ this project on
